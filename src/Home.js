          ...
          <div class="box-filling-holder">
            ...
            <div class="box-filling d-flex show-calender" onClick={showCalenderHolder}>
              ...
              <span class="check-in-input">
                {dateRange.startDate ? dateRange.startDate.toLocaleDateString('en-US', { weekday: 'short', day: '2-digit', month: 'short' }) : 'Check-in date'}
              </span>
              <span class="dash"> — </span>
              <span class="check-out-input">
                {dateRange.endDate ? dateRange.endDate.toLocaleDateString('en-US', { weekday: 'short', day: '2-digit', month: 'short' }) : 'Check-out date'}
              </span>
            </div>

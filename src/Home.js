...
const Home = () => {
  ...
  const handleClickOutside = (event) => {
    const datePickerHolder = document.querySelector('.date-picker-holder');
    const calendarBtn = document.getElementById('calender-btn');
    if (datePickerHolder && !datePickerHolder.contains(event.target) && !calendarBtn.contains(event.target)) {
      ...
      <div class="calender-holder">
        ...
        <div class="container calender">
          <div class="box-filling-holder">
            ...
            <div class="box-filling d-flex" id="calender-btn">
              <div class="box-filling-icon">

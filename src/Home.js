...
const Home = () => {
  ...
  useEffect(() => {
    const updateDateDisplay = () => {
      const dateRangeHeader = document.querySelector('.rs-picker-daterange-header');
      if (dateRangeHeader) {
        const spans = dateRangeHeader.querySelectorAll('span');
        if (spans.length === 3) {
          setStartDate(spans[0].innerText);
          setEndDate(spans[2].innerText);
        }
      }
    };
    ...
    <div>
      <div class="calender-holder">
        ...
        <div class="container calender">
          <div class="box-filling-holder" id="box-filling-holder">
            ...
            <div class="box-filling d-flex show-calender" id="show-calender" onClick={showCalenderHolder}>
              <div class="box-filling-icon">
              ...
              <span class="check-in-input">{startDate || 'Check-in date'}</span>
              <span class="dash"> — </span>
              <span class="check-out-input">{endDate || 'Check-out date'}</span>
            </div>

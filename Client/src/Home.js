...
const Home = () => {
  ...
  return (
    <div class="parent-home">
      ...
      <div className='holiday-rentals container'>
        <h4>Holiday rentals for every kind of trip</h4>
        <div className='holiday-rentals-grids'>
